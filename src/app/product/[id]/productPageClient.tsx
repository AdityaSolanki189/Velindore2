...
const Product3DModel = dynamic(
  () => import("../../components/product3DModel"),
  {
    ssr: false,
  }
);
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto p-4 font-sans">
        <div className="text-sm text-gray-600 mb-4">{product.tag}</div>
              ...
              >
                <Heart
                  className={`w-6 h-6 cursor-pointer transition-colors duration-200 ${
                    isFavorite ? "fill-red-500 text-red-500" : "stroke-gray-500"
                  }`}
